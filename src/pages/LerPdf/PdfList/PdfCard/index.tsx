    ...
    return (
        <div className="flex flex-col items-center justify-between gap-3 rounded shadow p-3 text-wrap max-w-[230px] flex-1 hover:scale-[1.05] transition-all duration-300" style={{maxWidth:imageWidth + 12, maxHeight:imageHeight + (imageHeight * .5)}} >
            ...
            <div className="flex gap-2 flex-col items-start justify-center"  >
                <Popover>
                    <PopoverTrigger className="relative group flex gap-2 items-start justify-center" style={{width:imageWidth, height:imageHeight}} >
                        <img 
                    ...
                    <PopoverContent>
                        ...
                        <div className="text-sm font-normal mb-2" >
                            {privilegesData.coverGenerationForPrivateDocs ? `Você possui ${privilegesData.coverGenerationForPrivateDocs} gerações de imagem da capa gratuitas.` : `Gere uma nova imagem representando o conteúdo por apenas R$${0.80.toFixed(2)} reais`}
                        </div>
