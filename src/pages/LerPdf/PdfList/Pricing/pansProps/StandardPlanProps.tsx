...
export default function StandardPlanProps({ pricing }:{ pricing?:Control['pricing']['readPdf'] }) {
    ...
    return (
        <div className="mt-3 flex flex-col gap-3 w-full" >
            <PrincingProp { ...{bonus:{amount:60, desc:`Perguntas gratuitas por Mês`}, paid:{amount:questions, desc:`por perguntas adicionais`}, desc:questionsDesc} }  />
            ...
            <PrincingProp { ...{bonus:{amount:5, desc:`Upload de PDf gratuito por Mês`}, paid:{amount:pdfUpload, desc:`a cada 100.000 palavras, por PDFs adicionais`}, desc:pdfUploadDesc} }  />
            <PrincingProp { ...{bonus:{amount:3, desc:`Gerações de Capas gratuitas por Mês`}, paid:{amount:cover, desc:`por capas adicionais`}, desc:coverDesc} }  />
            ...
            <PrincingProp { ...{bonus:{amount:3, desc:`Gerações de Quizzes Privados gratuitos por Mês`}, paid:{amount:quizPrivate, desc:`por quizzes privados adicionais`}, desc:quizPrivateDesc} }  />
        </div>
    );
};