...
export default function SubmitSetupButton({  }:SubmitSetupButtonProps) {
  ...
  return (
    <div className='w-[100vw] flex m-auto items-center justify-center' >
      <button className='mt-5 w-[90%] py-[10px] self-center rounded-md' style={{backgroundColor:colors.kobi()}} onClick={async() => await submit({stripe, elements})} disabled={loading} >
